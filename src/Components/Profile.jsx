...
import Avanish from "./SocialLinks/profle.jpeg";
import "../Components/Global.css";
import cv from "../Components/SocialLinks/Avanish-Porwal-Developer.pdf";
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={Avanish} className="w-screen rounded-lg h-full" />
          </div>
          <h1
          ...
          <div
            className="passion h-8 p-2 relative lg:top-12 sm:top-20"
            style={{
              background: `${bgcolor === "white" ? "#f3f6f6" : "#1D1D1D"}`,
            }}
          >
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://github.com/Avanishdev" target="#">
                {" "}
                <BsGithub
            ...
            >
              <a href="https://codolio.com/profile/avnishdev" target="#">
                {" "}
                <FaUserTie className="text-2xl text-red-400   fw-bold" />{" "}
              </a>
            </div>
            ...
            >
              <a
                href="https://www.linkedin.com/in/avanish-porwal-475406281/"
                target="#"
              >
                {" "}
            ...
            >
              <a href="https://x.com/PorwalAvanish" target="#">
                {" "}
                <FaTwitter className="text-2xl text-red-400   fw-bold" />{" "}
              </a>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="phone">
                <a href="mailto:avanishporwal01@gmail.com">
                  <h1
                    className={`${
                      bgcolor === "white" ? "text-black" : "text-white"
                    } text-sm sm:text-sm`}
                  >
                    avanishporwal01@gmail.com
                  </h1>
                </a>
              </div>
            </div>
          ...
          <div className="flex relative top-5">
            <button className="bg-blue-500 flex items-center rounded-lg justify-center text-white p-2 text-md text-nowrap w-36 h-10">
              <a href={cv} download="Avanish-Porwal-Developer" className="flex">
